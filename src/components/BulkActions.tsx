    ...
    <AnimatePresence>
      {count > 0 && (
        <motion.div
          ...
          className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 bg-[#121C35] border border-[#1E2A45] rounded-xl shadow-2xl px-5 py-3 flex items-center gap-4"
        >
          <span className="text-xs font-medium text-[#CBD2DF]">
          ...
          {onExport && (
            <button
              onClick={onExport}
              className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-[#1E2A45] border border-[#2A3A5C] rounded-lg text-xs font-medium text-[#9AA5B8] hover:bg-[#2A3A5C] transition-colors"
            >
